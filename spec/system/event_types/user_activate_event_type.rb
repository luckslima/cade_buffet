...
describe 'Usuário Dono de Buffet reativa o tipo de evento' do 
    ...
    it 'a partir da tela de detalhes do tipo de evento' do 
        ...
        expect(page).not_to have_link "Desativar tipo de evento"
    ...
    it 'com sucesso' do 
        ...
        click_on 'Halloween'
        click_on 'Reativar tipo de evento'

        #Assert
        expect(page).to have_content "Tipo de evento reativado com sucesso!"
