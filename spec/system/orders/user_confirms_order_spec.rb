...
describe 'Usuário cliente tenta confirmar pedido' do 
    ...
    it 'com sucesso' do
        ...
        order_budget = OrderBudget.create!(user: client, buffet: buffet, order: order, valid_until: 1.month.from_now, payment_method: method_2)
    ...
    it 'e a data limite já foi excedida' do
        ...
        order = Order.create!(buffet: buffet, user:client, event_type: event_type, number_of_guests: 150, 
                              event_date: 1.month.from_now, details: 'Halloween fora de época', payment_method: method_2, status: :approved)
        order_budget = OrderBudget.create!(user: client, buffet: buffet, order: order, valid_until: 1.month.ago, payment_method: method_2)
