...
describe 'Usuário cliente confirma pedido' do 
    ...
    it 'com sucesso' do
        ...
        order = Order.create!(buffet: buffet, user:client, event_type: event_type, number_of_guests: 150, 
                              event_date: 1.month.from_now, details: 'Halloween fora de época', status: :approved)
        order_budget = OrderBudget.create!(user: client, buffet: buffet, order: order, valid_until: 1.month.from_now, payment_method: "Pix")
    ...
    it 'e a data limite já foi excedida' do
        #Arrange
        user = User.create!(name: 'Patricia', cpf: '21642440795', email: 'paty@gmail.com', password: 'paty123', is_buffet_owner: true)
        buffet = Buffet.create!(brand_name: "Patty Buffet", corporate_name: "Patty Buffet LTDA", registration_number: "1254783654", 
                                phone: "71-85642014", email: "pattybuffet@email.com", address: "Av oceânica, 100", district: "Barra", 
        ...
        order = Order.create!(buffet: buffet, user:client, event_type: event_type, number_of_guests: 150, 
                              event_date: 1.month.from_now, details: 'Halloween fora de época', status: :approved)
        order_budget = OrderBudget.create!(user: client, buffet: buffet, order: order, valid_until: 1.month.ago, payment_method: "Pix")
