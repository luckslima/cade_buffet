...
buffet_1 = Buffet.create!(brand_name: "Luke's Buffet", corporate_name: "Luke's Buffet LTDA", registration_number: "36817610000120", 
                          phone: "71-88442014", email: "lukesbuffet@email.com", address: "Av oceânica, 100", district: "Barra", 
                          city: "Salvador", state: "Bahia", zip_code: "40527-700", description: "Buffet radical para todas as horas!", 
                          payment_methods: "Boleto, Cartão e Pix", user: lucas)

buffet_2 = Buffet.create!(brand_name: "Sofia's Delights", corporate_name: "Sofia Santos Eventos Ltda", registration_number: "47025410000196",
                          phone: "31-982244581", email: "contact@sofiasdelights.com", address: "Rua das Palmeiras, 287", district: "Centro",
                          city: "Belo Horizonte", state: "Minas Gerais", zip_code: "30130-160", description: "Eventos memoráveis com um toque pessoal.",
                          payment_methods: "Cartão de Crédito, Débito e Pix", user: sofia)

buffet_3 = Buffet.create!(brand_name: "Buffet do Biel", corporate_name: "Buffet do Gabriel Alencar Eireli", registration_number: "52924471000158",
                          phone: "85-977355641", email: "gabisbuffet@contact.com", address: "Av. Beira Mar, 1020", district: "Praia de Iracema",
                          city: "Fortaleza", state: "Ceará", zip_code: "60165-121", description: "Luxo e elegância em cada detalhe.", 
                          payment_methods: "Transferência, Boleto e Cartão de Crédito", user: gabriel)


buffet_4 = Buffet.create!(brand_name: "Buffet Ana Carla", corporate_name: "AC Eventos S/A", registration_number: "14796352000177",
                          phone: "21-33445566", email: "events@anacarla.com", address: "Largo do Machado, 29", district: "Catete",
                          city: "Rio de Janeiro", state: "Rio de Janeiro", zip_code: "22221-020", description: "Transformamos seu sonho em realidade.",
                          payment_methods: "Cartão, Dinheiro e Pix", user: ana)
